#ifndef MSC_DUMB_STORING_MESH_FUNCTION
#define MSC_DUMB_STORING_MESH_FUNCTION
...
class mscDumbStoringMeshFunction : public mscBasicMeshFunction<dtype> {
protected:
   ...
   dtype max_of_facets(CELL_INDEX_TYPE cellid) {
...
public:
	mscDumbStoringMeshFunction(mscBasicDataHandler<dtype>* data_handler,
	...
	virtual ~mscDumbStoringMeshFunction() {
				printf("delete: mscDumbStoringMeshFunction \n");
